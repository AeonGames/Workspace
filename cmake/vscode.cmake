...
if(CMAKE_GENERATOR MATCHES "(MSYS|Unix) Makefiles")
    ...
    if(CMAKE_GENERATOR MATCHES "MSYS Makefiles")
        set(DEBUG_PATH "${CMAKE_BINARY_DIR}/src;$ENV{MINGW_PREFIX}/bin")
    else()
        set(DEBUG_PATH "${CMAKE_BINARY_DIR}/src:$ENV{PATH}")
    endif()

    set(DEBUG_CONFIGURATIONS "")

    file(GLOB_RECURSE directories LIST_DIRECTORIES true ${CMAKE_SOURCE_DIR}/src *)
    
    foreach(DIRECTORY ${directories})
        string(REPLACE "${CMAKE_SOURCE_DIR}/src/" "" TARGET_LOCATION ${DIRECTORY})
            ...
            foreach(TARGET ${TARGETS})
                ...
                if (${target_type} STREQUAL "EXECUTABLE")
                    ...
                    \"externalConsole\": true,
                            \"program\": \"${CMAKE_BINARY_DIR}/src/${TARGET}${CMAKE_EXECUTABLE_SUFFIX}\",
